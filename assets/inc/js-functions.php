...
function comercio_script()
{
    ...
    wp_register_script('bootstrap-js', 'https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.bundle.min.js' . '/assets/librerias/js/mis-scripts.js', true);
